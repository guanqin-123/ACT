...
def _build_input_spec(
    ...
    lb_tensor = torch.tensor(lb_vals, dtype=torch.float32)
    ub_tensor = torch.tensor(ub_vals, dtype=torch.float32)
...
def _build_output_spec(
    ...
    return OutputSpec(
        ...
        c=torch.tensor(rows_c, dtype=torch.float32),
        d=torch.tensor(rows_d, dtype=torch.float32),
    )
