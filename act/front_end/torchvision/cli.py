    ...
    if model_name in model_cache:
        ...
        try:
            ...
            if hasattr(torchvision.models, model_name):
                ...
                from act.front_end.torchvision.model_definitions import get_model
...
def main():
    ...
    if args.list:
        ...
        try:
            ...
            print(f"Use: python -m act.front_end.torchvision.cli --download {dataset_name} {model_name}")
        except ValueError as e:
            print(f"✗ Error: {e}")
        except Exception as e:
        ...
        try:
            ...
            print(f"   {e}")
            print(f"\nDownload first with:")
            print(f"   python -m act.front_end.torchvision.cli --download {dataset_name} {model_name}")
        except ValueError as e:
            print(f"\n✗ Error: {e}")
        except Exception as e:
            print(f"\n✗ Unexpected error: {e}")
        ...
        try:
            ...
            if preprocessing:
                ...
                print(f"  from act.front_end.torchvision.data_model_mapping import create_preprocessing_pipeline")
