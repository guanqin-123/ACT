...
def _resolve_perturbation_norm(value: Any) -> float:
    ...
    EMBEDDING_LP carries the input perturbation norm ``p``; box / L_inf specs
...
class DualSolver(Solver):
    ...
    def _input_contribution_from_nu(self, net: Net, input_lid: int,
        ...
        concretization ``lb·[nu]_+ + ub·[nu]_-``. For a finite-p EMBEDDING_LP
        ...
        with torch.set_grad_enabled(enable_grad):
            ...
            # A finite input Lp ball (EMBEDDING_LP) is concretized by its exact
